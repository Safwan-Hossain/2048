...
//
//        game = new Game(4, 1);
//        Positions gamePositions = game.getPositions();
//        HashSet<int[]> availablePositions = new HashSet<>();
//        availablePositions.add(new int[]{1, 1});
//        availablePositions.add(new int[]{2, 3});
//        gamePositions.setAvailablePositions(availablePositions);
//        game.rotateGame(1);
//        gamePositions.removeAvailablePosition(2, 1);
//        gamePositions.removeAvailablePosition(0, 2);
//        System.out.println(availablePositions.size());
//        assertEquals(0, availablePositions.size());
//    }
...
//        game.getPositions().setAvailablePositions(new HashSet<>());
    ...
    private boolean compareMatrices(int[][] m1, Board board) {
        for (int i = 0; i < board.getBoardSize(); i++) {
            for (int j = 0; j < board.getBoardSize(); j++) {
                if (m1[i][j] != board.getNumberAt(i, j)) {
                    return false;
                }
            }
        }
